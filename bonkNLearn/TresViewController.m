...
-(void)motionBegan:(UIEventSubtype)motion withEvent:(UIEvent *)event {
    ...
    //
    NSString *music = [[NSBundle mainBundle]pathForResource:@"Tres" ofType:@"mp3"];
...
-(void)delay
{
    [self performSelector:@selector(tresPlayed)
               withObject:(nil)
               afterDelay:(1.0)];
...
- (void)quatroPlay
{
    [self performSegueWithIdentifier:@"tresToQuatro" sender:nil];
