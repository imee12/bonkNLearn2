...
-(void)motionBegan:(UIEventSubtype)motion withEvent:(UIEvent *)event {
    ...
    //
    NSString *music = [[NSBundle mainBundle]pathForResource:@"8" ofType:@"mp3"];
...
-(void)delay
{
    [self performSelector:@selector(eightPlayed)
               withObject:(nil)
               afterDelay:(1.0)];
...
- (void)ninePlay
{
    [self performSegueWithIdentifier:@"eightToNine" sender:nil];
