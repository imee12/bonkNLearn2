...
-(void)motionBegan:(UIEventSubtype)motion withEvent:(UIEvent *)event {
    ...
    //
    NSString *music = [[NSBundle mainBundle]pathForResource:@"Cinco" ofType:@"mp3"];
...
-(void)delay
{
    [self performSelector:@selector(cincoPlayed)
               withObject:(nil)
               afterDelay:(1.0)];
...
- (void)seisPlay
{
    [self performSegueWithIdentifier:@"cincoToSeis" sender:nil];
